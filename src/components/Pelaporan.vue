...
const submitFormLaporan = async () => {
  ...
  try {
    ...
    toast.removeGroup('loading-toast')
  }
}
...
<template>
  <form 
    ...
    <div class="bg-surface-0 dark:bg-surface-900 rounded-2xl mb-6 px-6 py-4 md:px-6 md:py-3 border-b md:border border-surface-200 dark:border-surface-700 w-full sticky top-0 z-30">
