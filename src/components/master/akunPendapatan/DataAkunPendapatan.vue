...
import ModalAkunPendapatan from '@/components/master/akunPendapatan/ModalAkunPendapatan.vue'
...
const rekPendapatanOptions = ref([
  { label: 'Hasil Pemanfaatan Aset', value: 'Hasil Pemanfaatan Aset' },
  { label: 'Jasa Layanan', value: 'Jasa Layanan' },
  { label: 'Denda Keterlambatan', value: 'Denda Keterlambatan' },
  { label: 'Langsung', value: 'Langsung' },
  { label: 'Jasa Giro', value: 'Jasa Giro' },
  { label: 'Pengembalian Belanja BLUD', value: 'Pengembalian Belanja BLUD' },
  { label: 'Hasil Kerja Sama Dengan Pihak Lain', value: 'Hasil Kerja Sama Dengan Pihak Lain' },
  { label: 'Belanja', value: 'Belanja' },
  { label: 'Komisi dan Bentuk Lain', value: 'Komisi dan Bentuk Lain' },
  { label: 'Mutasi Kas', value: 'Mutasi Kas' },
  { label: 'Bunga Deposito', value: 'Bunga Deposito' },
  { label: 'Pendidikan dan Pelatihan', value: 'Pendidikan dan Pelatihan' },
])
const kelompokOptions = ref([
  { label: 'LAIN-LAIN', value: 'LAIN-LAIN' },
  { label: 'PENERIMAAN', value: 'PENERIMAAN' },
  { label: 'NON PENDAPATAN', value: 'NON PENDAPATAN' },
  { label: 'PENJAMINAN', value: 'PENJAMINAN' },
  { label: 'PIUTANG', value: 'PIUTANG' },
  { label: 'DROPING', value: 'DROPING' },
])
...
const loadData = async (page = 1, pageSize = rows.value) => {
  ...
  try {
    ...
    const response = await api.get('/akun', { params: query })
...
const handleEdit = async (item) => {
  try {
    loading.value = true
    const response = await api.get(`/akun/${item.id}`)
    if (response.data) {
...
<template>
  <div class="p-4">
      ...
      >
        ...
        >
            ...
            <template #filter="{ filterModel }">
              <InputText v-model="filterModel.value" type="text" placeholder="Search Akun ID" />
            </template>
        </Column>
        <Column 
          field="akun_kode" 
        ...
        >
            ...
            <template #filter="{ filterModel }">
              <InputText v-model="filterModel.value" type="text" placeholder="Search Akun Kode" />
            </template>
        </Column>
        <Column 
          field="akun_nama" 
        ...
        >
            ...
            <template #filter="{ filterModel }">
              <InputText v-model="filterModel.value" type="text" placeholder="Search Akun Nama" />
            </template>
        </Column>
        <Column 
          field="rek_id" 
        ...
        >
            ...
            <template #filter="{ filterModel }">
              <InputText v-model="filterModel.value" type="text" placeholder="Search Akun Rekening" />
            </template>
        </Column>
        <Column 
          field="rek_nama" 
        ...
        >
            ...
            <template #filter="{ filterModel }">
              <InputText v-model="filterModel.value" type="text" placeholder="Search Akun Nama Rekening" />
            </template>
        </Column>
        <Column 
          field="akun_kelompok" 
        ...
        >
            ...
            <template #filter="{ filterModel }">
              <InputText v-model="filterModel.value" type="text" placeholder="Search Akun Kelompok" />
            </template>
        </Column>
      </DataTable>
    </div>
    <ModalAkunPendapatan 
      ...
      :item="selectedItem" 
      :options="{
        rekPendapatan: rekPendapatanOptions,
