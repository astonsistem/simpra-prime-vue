      ...
      <TabList class="mb-4">
        <Tab v-slot="slotProps" value="0" asChild>
          <div :class="['flex flex-col', slotProps.class]" @click="slotProps.onClick" v-bind="slotProps.a11yAttrs">
            <Button variant="outlined" :severity="slotProps.active ? 'primary':'secondary'" class="mb-1">Billing Kasir</Button>
            <div class="text-xs text-gray-400"><i class="pi pi-chart-line text-amber-300" style="font-size: 0.7rem"></i> {{  hitungTotalBruto(billingKasirItems) }}</div>
            <div class="text-xs text-gray-400"><i class="pi pi-chart-line text-green-300" style="font-size: 0.7rem"></i> {{  hitungTotalNetto(billingKasirItems) }}</div>
          </div>
        </Tab>
        <Tab v-slot="slotProps" value="1" asChild>
          <div :class="['flex flex-col', slotProps.class]" @click="slotProps.onClick" v-bind="slotProps.a11yAttrs">
            <Button variant="outlined" :severity="slotProps.active ? 'primary':'secondary'" class="mb-1">Penerimaan Selisih</Button>
            <div class="text-xs text-gray-400"><i class="pi pi-chart-line text-amber-300" style="font-size: 0.7rem"></i> {{  hitungTotalBruto(penerimaanSelisih) }}</div>
            <div class="text-xs text-gray-400"><i class="pi pi-chart-line text-green-300" style="font-size: 0.7rem"></i> {{  hitungTotalNetto(penerimaanSelisih) }}</div>
          </div>
        </Tab>
        <Tab v-slot="slotProps" value="2" asChild>
          <div :class="['flex flex-col', slotProps.class]" @click="slotProps.onClick" v-bind="slotProps.a11yAttrs">
            <Button variant="outlined" :severity="slotProps.active ? 'primary':'secondary'" class="mb-1">Penerimaan Lain</Button>
            <div class="text-xs text-gray-400"><i class="pi pi-chart-line text-amber-300" style="font-size: 0.7rem"></i> {{  hitungTotalBruto(penerimaanLain) }}</div>
            <div class="text-xs text-gray-400"><i class="pi pi-chart-line text-green-300" style="font-size: 0.7rem"></i> {{  hitungTotalNetto(penerimaanLain) }}</div>
          </div>
        </Tab>
      </TabList>
      <TabPanels>
