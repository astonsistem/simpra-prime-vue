<template>
  <Dialog :visible="visible" @update:visible="visible = $event" modal :header="isEdit ? 'Edit Data' : 'Tambah Data'"
    :style="{ width: '75vw' }" :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
    <template #header>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-sm">
      <div legend="Informasi Billing">

        <div class="mb-4">
          <label class="block mb-1 text-sm font-medium text-gray-700">Tgl. Setor <span
              class="text-red-500">*</span></label>
          <DatePicker v-model="form.tgl_setor" showIcon date-format="yy-mm-dd" class="w-full"
        ...
        <div class="mb-4">
          ...
          <Dropdown v-model="form.jenis" :options="optionsJenis" optionLabel="label" optionValue="value" class="w-full"
        ...
        <div class="mb-4">
          <label class="block mb-1 text-sm font-medium text-gray-700">Cara Pembayaran <span
              class="text-red-500">*</span></label>
          <Dropdown v-model="form.cara_pembayaran" :options="optionsCaraPembayaran" optionLabel="label"
            optionValue="value" class="w-full" :invalid="errors?.cara_pembayaran?.length" />
        ...
        <div class="mb-4">
          <label class="block mb-1 text-sm font-medium text-gray-700">Rekening Bank <span
              class="text-red-500">*</span></label>
          <Dropdown v-model="form.bank_tujuan" :options="optionsBankTujuan" optionLabel="label" optionValue="value"
            class="w-full" :invalid="errors?.bank_tujuan?.length" />
        ...
        <div class="mb-4">
          <label class="block mb-1 text-sm font-medium text-gray-700">Jumlah Setor <span
              class="text-red-500">*</span></label>
        ...
        <!-- Biaya Admin EDC -->
        <div class="mb-4">
          <label class="block mb-1 text-sm font-medium text-gray-700">Admin EDC <span
              class="text-red-500">*</span></label>
          <InputNumber v-model="form.admin_kredit" class="w-full" mode="currency" currency="IDR" locale="id-ID"
            show-buttons :step="1000" :min="0" :invalid="errors?.admin_kredit?.length" />
        </div>
        ...
        <div class="mb-4">
          <label class="block mb-1 text-sm font-medium text-gray-700">Admin QRIS <span
              class="text-red-500">*</span></label>
          <InputNumber v-model="form.admin_debit" class="w-full" mode="currency" currency="IDR" locale="id-ID"
            show-buttons :step="1000" :min="0" :invalid="errors?.admin_debit?.length" />
        ...
        <div class="mb-4">
          ...
          <InputNumber v-model="form.jumlah_netto" class="w-full" mode="currency" currency="IDR" locale="id-ID" readonly
            disabled />
      ...
      <div legend="Informasi Detail">
        <div class="mb-4">
          <label class="block mb-1 text-sm font-medium text-gray-700">Penyetor</label>
          <InputText v-model="form.penyetor" class="w-full" :invalid="errors?.penyetor?.length" />
        ...
        <div class="mb-4">
          ...
          <Dropdown v-model="form.rek_id" :options="optionsRekeningDpa" optionLabel="label" optionValue="value"
            placeholder="Pilih Rekening DPA" class="w-full" :invalid="errors?.rek_id?.length" />
        ...
        <div class="mb-4">
          ...
          <Dropdown v-model="form.sumber_transaksi" :options="optionsSumberTransaksi" optionLabel="label"
            optionValue="value" placeholder="Pilih Sumber Transaksi" class="w-full"
      ...
      <Fieldset legend="Bukti Kwitansi / Setor">

        <div class="mb-4">
          <label class="block mb-1 text-sm font-medium text-gray-700">Tgl. Bukti</label>
          <DatePicker v-model="form.tgl_buktibayar" showIcon date-format="yy-mm-dd" class="w-full"
        ...
        <div class="mb-4">
          ...
          <InputText v-model="form.no_buktibayar" class="w-full" :invalid="errors?.no_buktibayar?.length" />
        ...
        <div class="mb-4">
          ...
          <Dropdown v-model="form.kasir_id" :options="optionsKasir" optionLabel="label" optionValue="value"
            class="w-full" :invalid="errors?.kasir_id?.length" />
          <div v-if="errors.kasir_id" class="text-red-500 text-sm mt-1">
            {{ errors?.kasir_id[0] }}
          </div>
        </div>
        ...
        <div class="mb-4">
          ...
          <Dropdown v-model="form.loket_id" :options="optionsLoket" optionLabel="label" optionValue="value"
            class="w-full" :invalid="errors?.loket_id?.length" />
          <div v-if="errors.loket_id" class="text-red-500 text-sm mt-1">
            {{ errors?.loket_id[0] }}
          </div>
        </div>
      </Fieldset>
    ...
    <template #footer>
      ...
      <Button label="Simpan" icon="pi pi-check" @click="submit" :loading="loading" class="p-button-success" />
    </template>
  </Dialog>
</template>
...
import useKasir from '@/composables/useKasir'
import useLoket from '@/composables/useLoket'
...
const { fetchList: fetchKasir, options: optionsKasir } = useKasir()
const { fetchList: fetchLoket, options: optionsLoket } = useLoket()
