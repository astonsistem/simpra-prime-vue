      ...
      <TabView v-model:activeIndex="activeTab">
        ...
        <TabPanel header="Ubah ID Transaksi">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
            <div class="field">
              <label class="block mb-2 font-semibold">No. RC</label>
              <InputText v-model="formData.no_rc" disabled class="w-full" />
            </div>

            <div class="field">
              <label class="block mb-2 font-semibold">Tgl. RC</label>
              <InputText v-model="formData.tgl_rc" disabled class="w-full" />
            </div>

            <div class="field md:col-span-2">
              <label class="block mb-2 font-semibold">Uraian</label>
              <Textarea v-model="formData.uraian" disabled class="w-full" rows="3" />
            </div>

            <div class="field">
              <label class="block mb-2 font-semibold">Bank</label>
            ...
            <div class="field">
              <label class="block mb-2 font-semibold">Mutasi</label>
              <Checkbox v-model="formData.mutasi" :binary="true" />
            </div>

            <div class="field">
              <label class="block mb-2 font-semibold">PB dari Bank</label>
              <Select
